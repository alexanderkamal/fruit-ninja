 ...
 * @author Amr Ashraf
 */
public class Strawberry implements GameObjectsFruits{
...
int x=300 , y=850;
int intialvelocity=15,fallingvelocity=20;
int score = 20 ;
String position;
...
@Override
    ...
    public ArrayList<ImageIcon> getBufferedImage() {
       ...
       ImageIcon i1 = new ImageIcon("Strawberrycopy.png");
       ImageIcon i2 = new ImageIcon("SlicedStawberrycopy.png");
