 ...
 * @author Amr Ashraf
 */
public class WatermelonPlus1Live implements GameObjectsFruits{
...
int x=200 , y=250;
int intialvelocity=30,fallingvelocity=35;
int score = 20;
String position;
...
int nofmove=0;
    ...
    public int getNofmove() {
        return nofmove;
    }

    public void setNofmove() {
         nofmove++;
    }
...
@Override
    ...
    public ArrayList<ImageIcon> getBufferedImage() {
       ...
       ImageIcon i1 = new ImageIcon("wm.png");
       ImageIcon i2 = new ImageIcon("slicedwm.png");
       ImageIcon i3 = new ImageIcon("+1.png");
       images.add(i1) ;
       images.add(i2);
       images.add(i3);
       return images;
