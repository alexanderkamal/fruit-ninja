 ...
 * @author Amr Ashraf
 */
public class Pear implements GameObjectsFruits{
    
    boolean slice=false;
boolean offscreen=false;
boolean movingup=true;
int x=200 , y=250;
int intialvelocity=17,fallingvelocity=23;
int score = 20;
String position;
...
@Override
    ...
    public ArrayList<ImageIcon> getBufferedImage() {
       ...
       ImageIcon i1 = new ImageIcon("Pear.png");
       ImageIcon i2 = new ImageIcon("SlicedGuave.png");
       ImageIcon i3 = new ImageIcon("green.png");
       images.add(i1) ;
       images.add(i2);
       images.add(i3);
       return images;
